                        ...
                        <div class="col-sm-7 d-none d-md-block">
                            <div class="btn-group btn-group-toggle float-right mr-3" data-toggle="buttons">
                                <label class="btn btn-outline-secondary" onclick="getData('month')">
                                    <input id="option1" type="radio" name="options" autocomplete="off">month
                                </label>
                                <label class="btn btn-outline-secondary " onclick="getData('year')">
                                    <input id="option2" type="radio" name="options" autocomplete="off" checked="">year
                                </label>
                                <label class="btn btn-outline-secondary active" onclick="getData('all')">
                                    <input id="option3" type="radio" name="options" autocomplete="off">all
                                </label>
                            </div>
                        </div>
                        <!-- /.col-->
